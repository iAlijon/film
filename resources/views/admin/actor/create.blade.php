                    ...
                    <form action="{{route('actor.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="custom-tabs-three-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel">
                                ...
                                <div class="form-group">
                                    <label for="description_uz">Qisqacha ma'lumoq (UZ)</label>
                                    <textarea name="description_uz" id="" cols="30" rows="5" class="form-control form-control-sm"></textarea>
