            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Booksgroup</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-11 mr-auto ml-auto">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Kitob Mavzulari <i class="fas fa-users"></i></h3>
                    <div class="text-right">
                        <a href="{{route('bookgroup.create')}}" class="btn btn-success">&plus; Qo'shish</a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <a href="{{route('bookgroup.edit', $model->id)}}" class="btn btn-info mr-2"><i class="fas fa-edit"></i></a>
                                            <form action="{{ route('bookgroup.destroy', $model->id) }}" method="post"
