    ...
    <section class="content">
        <div class="col-11 ml-auto mr-auto">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="{{route('cinema_fact.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="tab-content" id="custom-tabs-three-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_oz" class="form-control @error('name_oz') border-danger @enderror" placeholder="Nomi" value="{{old('name_oz')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_oz" id="" cols="30" rows="5" class="form-control @error('description_oz') border-danger @enderror">{{old('description_oz')}}</textarea>
                                    <small class="text-danger">{{$errors->first('description_oz')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="content_oz">To'liq ma'lumot</label>
                                    <textarea name="content_oz" id="" cols="30" rows="10" class="textarea form-control summernote @error('content_oz') border-danger @enderror">{{old('content_oz')}}</textarea>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_uz" class="form-control @error('name_uz') border-danger @enderror" placeholder="Номи" value="{{old('name_uz')}}">
                                    <small class="text-danger">{{$errors->first('name_uz')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="description_uz">Қисқача маълумоти</label>
                                    <textarea name="description_uz" id="" cols="30" rows="5" class="form-control @error('description_uz') border-danger @enderror">{{old('description_uz')}}</textarea>
                                    <small class="text-danger">{{$errors->first('description_uz')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="content_uz">Тўлиқ маълумот</label>
                                    <textarea name="content_uz" id="" cols="30" rows="10" class="textarea form-control summernote @error('content_uz') border-danger @enderror">{{old('content_uz')}}</textarea>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-ru" role="tabpanel">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_ru" class="form-control @error('name_ru') border-danger @enderror" placeholder="Имя" value="{{old('name_ru')}}">
                                    <small class="text-danger">{{$errors->first('name_ru')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="description_ru">Краткая информация</label>
                                    <textarea name="description_ru" id="" cols="30" rows="5" class="form-control @error('description_ru') border-danger @enderror">{{old('description_ru')}}</textarea>
                                    <small class="text-danger">{{$errors->first('description_ru')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="content_ru">Полная информация</label>
                                    <textarea name="content_ru" id="" cols="30" rows="10" class="textarea form-control summernote @error('content_ru') border-danger @enderror">{{old('content_ru')}}</textarea>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-en" role="tabpanel">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_en" class="form-control @error('name_en') border-danger @enderror" placeholder="Name" value="{{old('name_en')}}">
                                    <small class="text-danger">{{$errors->first('name_en')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="description_en">Brief information</label>
                                    <textarea name="description_en" id="" cols="30" rows="5" class="form-control @error('description_en') border-danger @enderror">{{old('description_en')}}</textarea>
                                    <small class="text-danger">{{$errors->first('description_en')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="content_en">Full information</label>
                                    <textarea name="content_en" id="" cols="30" rows="10" class="textarea form-control summernote @error('content_en') border-danger @enderror">{{old('content_en')}}</textarea>
