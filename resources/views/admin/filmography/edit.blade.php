                        ...
                        <div class="tab-content" id="custom-tabs-three-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-ru" role="tabpanel">
                                ...
                                <div class="form-group required">
                                    ...
                                    <textarea name="content_ru" id="" cols="30" rows="10" class="form-control textarea @error('content_ru') border-danger @enderror">{{$model->content_ru}}</textarea>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-en" role="tabpanel">
                                ...
                                <div class="form-group required">
                                    ...
                                    <input type="text" class="form-control @error('name_en') border-danger @enderror" name="name_en" value="{{$model->name_en}}" placeholder="Name">
                                ...
                                <div class="form-group required">
                                    ...
                                    <textarea name="content_en" id="" cols="30" rows="10" class="form-control textarea @error('content_en') border-danger @enderror">{{$model->content_en}}</textarea>
