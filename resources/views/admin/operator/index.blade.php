            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('operator.index')}}">Home</a></li>
                        ...
                        <thead>
                            ...
                            <tr>
                                <form action="">
                                    ...
                                    <th></th>
                                    <th>
                                        <select name="operator_id" id="operator_id" class="form-control" onchange="this.form.submit()">
                                            <option value="">----</option>
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}" {{$category->id == request('operator_id')?'selected':''}}>{{$category->full_name_oz}}</option>
                                            @endforeach
                                        </select>
                                    </th>
                                    <th>
