            ...
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <div class="text-right">
                        <a href="{{route('portrait_artist.create')}}" class="btn btn-success btn-sm">&plus; Qo'shish</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a href="{{route('portrait_artist.edit', $item->id)}}" class="btn btn-info btn-sm mr-2"><i class="fas fa-edit"></i></a>
